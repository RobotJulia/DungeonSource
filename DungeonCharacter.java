...
//-----------------------------------------------------------------
	...
	//always overriden to get the type of character it is
...
---------------------------------------------------------*/
	public void subtractHitPoints(int damage)//hitPoints to damage
	{
		if (damage <0)
			System.out.println("Hitpoint amount must be positive.");
		else if (damage >0)
		{
			...
			this.remainingHealth(this.hitPoints);
	...
	private void remainingHealth(int health)
	{
		System.out.println(getName() + " now has " +
